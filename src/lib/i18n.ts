...
const dict = {
  zh: {
    ...
    'workout.result.title': '打卡完成',
    'workout.result.tap_to_open': '点击宝箱开卡',
    'workout.result.cta.battle': '去对战',
    'workout.result.cta.again': '再打一次',
    'workout.result.streak.new': '第 1 天 · 新的开始',
    'workout.result.streak.continued': '连续打卡 {n} 天 🔥',
    'workout.result.streak.same_day': '今天第二次 · 连续 {n} 天',
    'workout.result.streak.protected': '保护卡续命 · streak +1',
    'workout.result.streak.broken': '连击中断 · 重新开始',
    'loot.section': '§ 04 · 抽卡',
    'loot.title': '抽卡',
    ...
    'leaderboard.col.score': '积分',
    'leaderboard.anon_label': '匿名玩家',
    ...
    'clash.cards.currency_hint': '💰 解锁新卡 · 💎 升级已有卡（打卡掉落）',
    ...
    'onboarding.v2.brand': 'PULSE',
    'onboarding.v2.step_indicator': 'Step {n}/{total}',
    'onboarding.v2.step1.hero': '把跑步变成抽卡',
    'onboarding.v2.step1.sub':
      '运动给你金币，金币换卡，卡上桌打 AI。卡牌叫骑士、弓箭手、火龙——你认识的那种。',
    'onboarding.v2.step1.cta': '懂了 →',
    'onboarding.v2.step2.tag': '§ 01 · 模拟运动',
    'onboarding.v2.step2.running': '跑步中...',
    'onboarding.v2.step2.sub_running': '别真起来跑，体验一下流程',
    'onboarding.v2.step2.complete': '不错！',
    'onboarding.v2.step2.sub_complete': '运动 → 金币：这就是 PULSE 的核心循环',
    'onboarding.v2.step2.cta_continue': '继续 →',
    'onboarding.v2.step2.cta_skip': '跳过',
    'onboarding.v2.step3.tag': '§ 02 · 新手宝箱',
    'onboarding.v2.step3.title': '你的初始卡组',
    'onboarding.v2.step3.tap_to_open': '点击宝箱开启',
    'onboarding.v2.step3.opening': '开启中...',
    'onboarding.v2.step3.revealing': '翻牌中...',
    'onboarding.v2.step3.done': '6 张卡到手 · 1 张史诗',
    'onboarding.v2.step3.cta': '进入教学局',
    'onboarding.v2.tutorial.title': '你推下了一座塔',
    'onboarding.v2.tutorial.sub': '你已经会玩了 — 接下来真打就行',
    'onboarding.v2.tutorial.cta': '进入 PULSE',
    'onboarding.v2.tutorial.hint_1': '拖手牌到桥边部署',
    'onboarding.v2.tutorial.hint_2': '卡牌在屏幕底部 · 长按拖到桥位',
    'onboarding.v2.tutorial.hint_3': '需要跳过教学？',
    'onboarding.v2.tutorial.skip': '跳过教学',
  ...
  en: {
    ...
    'workout.result.title': 'Workout logged',
    'workout.result.tap_to_open': 'Tap chest to reveal card',
    'workout.result.cta.battle': 'Battle now',
    'workout.result.cta.again': 'Log another',
    'workout.result.streak.new': 'Day 1 · fresh start',
    'workout.result.streak.continued': '{n}-day streak 🔥',
    'workout.result.streak.same_day': 'Second time today · {n}-day streak',
    'workout.result.streak.protected': 'Protect card saved your streak · +1',
    'workout.result.streak.broken': 'Streak broken · starting fresh',
    ...
    'leaderboard.anon_label': 'Anonymous',
    ...
    'clash.cards.currency_hint': '💰 unlocks new cards · 💎 upgrades owned cards (from workouts)',
    ...
    'onboarding.v2.brand': 'PULSE',
    'onboarding.v2.step_indicator': 'Step {n}/{total}',
    'onboarding.v2.step1.hero': 'Workouts become a card game.',
    'onboarding.v2.step1.sub':
      'You exercise, you earn gold. You spend gold on cards. You take a deck onto the battlefield and beat the AI. Cards are Knight, Archer, Baby Dragon — the names you already know.',
    'onboarding.v2.step1.cta': 'Got it →',
    'onboarding.v2.step2.tag': '§ 01 · Mock workout',
    'onboarding.v2.step2.running': 'Running…',
    'onboarding.v2.step2.sub_running': "Don't actually go run. Just feel the loop.",
    'onboarding.v2.step2.complete': 'Nice!',
    'onboarding.v2.step2.sub_complete': 'Workout → gold. That is the PULSE loop.',
    'onboarding.v2.step2.cta_continue': 'Continue →',
    'onboarding.v2.step2.cta_skip': 'Skip',
    'onboarding.v2.step3.tag': '§ 02 · Starter pack',
    'onboarding.v2.step3.title': 'Your opening hand',
    'onboarding.v2.step3.tap_to_open': 'Tap the chest to open',
    'onboarding.v2.step3.opening': 'Opening…',
    'onboarding.v2.step3.revealing': 'Revealing…',
    'onboarding.v2.step3.done': '6 cards · 1 epic',
    'onboarding.v2.step3.cta': 'Tutorial battle',
    'onboarding.v2.tutorial.title': 'You took a tower',
    'onboarding.v2.tutorial.sub':
      "You know how to play now — ClashHome is waiting.",
    'onboarding.v2.tutorial.cta': 'Enter PULSE',
    'onboarding.v2.tutorial.hint_1': 'Drag a card to the bridge',
    'onboarding.v2.tutorial.hint_2': 'Cards live at the bottom · long-press + drag',
    'onboarding.v2.tutorial.hint_3': 'Need to skip the tutorial?',
    'onboarding.v2.tutorial.skip': 'Skip tutorial',
